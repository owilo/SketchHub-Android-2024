...
class Import : Fragment(), SearchFilterListener {
    ...
    private lateinit var importListener: ImportListener
    ...
    override fun onAttach(context: Context?) {
        ...
        importListener = context as ImportListener
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        pageChangeListener?.onPageChanged(getString(R.string.importCanvas))
